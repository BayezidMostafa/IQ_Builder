...
const Blog = () => {
  return (
    <div className="mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xxl md:px-24 lg:py-20">
      ...
      <div className='grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10 mx-10 sm:mx-0'>
        <div className='p-5 rounded-lg shadow shadow-black bg-violet-900 text-white'>
